...
.SYNOPSIS 
    ...
    resource id of a VM to stop.
    It then stops the VM and deallocates.
...
Write-Information ("Reading VM Id from queue and stopping the VM : $QueueItem")

# Stop the VM and deallocate
Get-AzResource -Id $QueueItem | Stop-AzVM -Force 
